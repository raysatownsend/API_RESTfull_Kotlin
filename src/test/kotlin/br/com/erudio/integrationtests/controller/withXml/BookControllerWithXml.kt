...
import br.com.erudio.integrationtests.vo.wrappers.WrapperBooksVO
...
class BookControllerWithXml() : AbstractIntegrationTest() {
	...
	fun testFindById() {
		...
		val foundBook = objectMapper.readValue(
			content,
			BookVO::class.java
		)
	...
	fun testFindAll() {
		...
		val wrapper = objectMapper.readValue(content, WrapperBooksVO::class.java)
	...
	@Test
	@Order(6)
	fun testFindingAllbooksWithoutToken() {
